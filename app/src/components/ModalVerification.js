...
const ModalVerification = ({ show, onClose, children }) => {
            ...
            <div className={ modalClasses }>
                ...
                <div className="mt-4">{ children }
                    <div className='flex justify-end text-white gap-4 mt-4'>
                        <button onClick={ (e) => yesButton(e, e.target.value) } value={ 'yes' } className='bg-blue-500 hover:bg-blue-700 py-2 px-4 rounded'>Yes</button>
